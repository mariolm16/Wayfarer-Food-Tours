...
4. Be redirected to their profile page after logging in OR signing up.
5. See the site-wide header on every page with:
  * A link to "Log Out" and their profile if they're logged in.
  * Links to "Log In" and "Sign Up" if they're logged out.
5. On their public profile page, see their name, image and the current city, and their join date.
...
10. View post "show" pages with title, author, and body.		
...
1. View the "San Francisco" page (at "/city/1") including:
...
5. Give option of edit or delete a post on the 'show' page if created by the User who is logged in.
5. Click "Edit", and be redirected to the edit form OR make the current form editable.
6. Click "delete", then:
...
6. A user MUST be logged in to create/update/destroy a post.
